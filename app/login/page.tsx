    ...
    try {
      ...
      if (response.ok && data.success) {
        toast({
          ...
          description: `Bem-vindo ao ${data.user.studioName || 'Workflow AI'}!`,
        })
        
        localStorage.setItem("danceflow_user", JSON.stringify(data.user))
        
        // Importante: Aguardar a sessão ser setada no client-side
        if (data.session) {
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-border">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Acesso para donos, gestores e colaboradores
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-6 text-center space-y-4">
                ...
                <div className="pt-4 border-t border-border">
                  <p className="text-xs text-muted-foreground mb-3 font-bold uppercase tracking-widest">Sou Cliente / Aluno / Profissional</p>
                  <Link href="/portal">
                    <Button variant="outline" className="w-full border-primary text-primary hover:bg-primary/5 font-bold h-11">
